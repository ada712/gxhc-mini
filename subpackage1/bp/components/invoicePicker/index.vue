		...
		<view class="popup" :class="{ on: invShow }">
							...
							<view class="text">
								...
								<view class="acea-row row-bottom">
									<view class="info-wrap">
										...
										<view v-if="item.header_type === 1" class="tel">联系电话
											{{item.drawer_phone}}
										</view>
									...
									<navigator v-if="!isOrder" class="navigator"
										...
										hover-class="none"><text class="iconfont icon-bianji"></text>编辑
									</navigator>
			...
			<view class="popup-ft">
				<navigator v-if="!isOrder" class="navigator"
					...
					<text class="iconfont icon-fapiao"></text>添加新的抬头
				</navigator>
				<navigator v-else class="navigator"
				...
				<button class="button" plain @click="invSub">确认提交</button>
			</view>
		</view>
	</view>
</template>
