				...
				<view class="edit">
					...
					<view class="nickname edit-box">
						<view class="left">
							...
							<view class='input'><input type='nickname' placeholder-class="pl-sty" :placeholder="`请输入昵称`"
									name='nickname' :maxlength="16" :value='userInfo.nickname'></input>
							</view>
						</view>
						<!-- <view class="iconfont icon-xiangyou"></view> -->
					</view>
...
<script>
	...
	import def_avatar from '@/static/images/def_avatar.png'
	import {
		userEdit,
	} from '@/api/user.js';
	export default {
